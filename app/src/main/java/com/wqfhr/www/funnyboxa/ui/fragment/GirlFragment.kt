...
import com.wqfhr.www.funnyboxa.ui.activity.ImageActivity
import com.wqfhr.www.funnyboxa.ui.adapter.GirlAdapter
...
class GirlFragment : BaseBingingFragment<ViewRecyclerBinding>(), FuckGoodsContract.View {
  ...
  override fun initView() {
    ...
    mAdapter.setOnItemClickListener { pos ->
      ...
      val imageView = recyclerView.findViewHolderForAdapterPosition(pos)?.itemView?.findViewById<ImageView>(R.id.iv_girl) as ImageView
